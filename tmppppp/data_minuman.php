            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="#" type="button " onclick="document.getElementById('modal-edit-minuman').style.display='flex'" data-toggle="modal" data-target="#modal-edit-minuman<?php echo $data1['id_minuman']; ?>">Edit</a>
                            <a href="../../../database/delete.php?id-minuman=<?php echo $data1['id_minuman']  ?>">Hapus</a>

                        </td>
                    </tr>
                    <!-- modal edit -->

                    <div class=" modal w3-modal modal-edit-mkn" id="modal-edit-minuman<?php echo $data1['id_minuman'] ?>">
